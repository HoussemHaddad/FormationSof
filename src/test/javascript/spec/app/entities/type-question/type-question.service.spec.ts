    ...
    describe('TypeQuestion Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/type-questions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TypeQuestion', () => {
                service.create(new TypeQuestion(null)).subscribe(received => {
            ...
            it('should update a TypeQuestion', () => {
                service.update(new TypeQuestion(123)).subscribe(received => {
            ...
            it('should return a TypeQuestion', () => {
            ...
            it('should return a list of TypeQuestion', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new TypeQuestion(123)]);
            });
