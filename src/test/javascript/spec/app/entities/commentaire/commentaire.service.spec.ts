    ...
    describe('Commentaire Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/commentaires';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Commentaire', () => {
                service.create(new Commentaire(null)).subscribe(received => {
            ...
            it('should update a Commentaire', () => {
                service.update(new Commentaire(123)).subscribe(received => {
            ...
            it('should return a Commentaire', () => {
