    ...
    describe('CategorieFormation Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/categorie-formations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CategorieFormation', () => {
                service.create(new CategorieFormation(null)).subscribe(received => {
            ...
            it('should update a CategorieFormation', () => {
                service.update(new CategorieFormation(123)).subscribe(received => {
            ...
            it('should return a CategorieFormation', () => {
            ...
            it('should return a list of CategorieFormation', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new CategorieFormation(123)]);
            });
